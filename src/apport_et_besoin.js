...
export default function calc_apport_et_besoin(
  ...
  let inertie = enums.classe_inertie[enveloppe.inertie.enum_classe_inertie_id]

  let bv = enveloppe.baie_vitree_collection.baie_vitree
  let nadeq
  ...
  let besoin_fr = calc_besoin_fr(ilpa, ca, zc, Sh, nadeq, GV, inertie, bv)
